...
import { MapPin, Calendar, DollarSign, Save, Loader2, Info } from 'lucide-react'
...
function CreateTripPage() {
    ...
    mutationFn: async () => {
      ...
      return await createTrip({
        data: {
          ...
          fundraisingGoal: parseInt(fundraisingGoal, 10) || 0,
          isRestrictedCountry,
        },
      })
    },
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const goal = parseInt(fundraisingGoal, 10)
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Set up your mission trip fundraising page"
      />
      ...
      <div className="max-w-2xl">
        <Alert className="mb-6">
          ...
          <AlertDescription>
            Create your trip now and add photos, invite followers, and activate
            fundraising later. You'll only pay the $10 activation fee when
