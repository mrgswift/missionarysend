  ...
  return (
    <PageContainer>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-8">
        ...
        <Card className="p-6 hover:shadow-lg transition-shadow">
          <h4 className="font-semibold mb-2">Invite Supporters</h4>
          <p className="text-sm text-muted-foreground mb-4">
...
function FollowerDashboard() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title={`Welcome, ${profile?.name || 'Supporter'}!`}
      ...
      {/* Trips */}
      <h2 className="text-xl font-semibold mb-6">Trips You're Following</h2>
      ...
      {isLoading ? (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {trips.map((trip) => (
            <TripCard key={trip.$id} trip={trip} linkTo={`/trip/${trip.$id}`} />
          ))}
        </div>
      )}
    </PageContainer>
...
function IntercessorDashboard() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title={`Welcome, ${profile?.name || 'Prayer Warrior'}!`}
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <Card className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-muted-foreground">Prayer Teams</span>
      ...
      {/* Trips */}
      <h2 className="text-xl font-semibold mb-6">Trips You're Praying For</h2>
      ...
      {isLoading ? (
        ...
        <Card className="p-12 text-center">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-2xl font-bold mb-2">No Prayer Teams Yet</h3>
            <p className="text-muted-foreground mb-6">
...
function TripCard({ trip, linkTo, isPrayer }: TripCardProps) {
  const progress =
